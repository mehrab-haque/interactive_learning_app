...
const MatchStciks=forwardRef((props,ref1)=>{
    ...
    const [cssWidth,setCssWidth]=useState('80%')
    ...
    useImperativeHandle(ref1, () => ({
        ...
        getVerdict(){
            return JSON.stringify(data.elements)===JSON.stringify(props.data.data.elements)
        }
    ...
    const loadUI=()=>{
        if(window.innerWidth>500)setCssWidth('45%')
